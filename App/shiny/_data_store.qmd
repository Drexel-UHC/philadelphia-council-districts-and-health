...
df_metadata = df_metadata_raw %>% 
  ...
  mutate(
       var_label = recode(
        ...
        "Native American" = "Race and Ethnicity: American Indian and Alaskan Native",
        "Asian" = "Race and Ethnicity: Asian",
        "Pacific Islander" = "Race and Ethnicity: Native Hawaiian and Pacific Islander",
        "Other Race" = "Race and Ethnicity: Other Race (Not Listed)",
        ...
        "Fatal Crashes" = "Fatal Car Crashes",
        "Active Business Licenses No Rentals" = "Active Business Licenses (Excluding Rental Business Licenses)",
        "Active Business Licenses Rentals Only" = "Active Rental Business Licenses",
        "Lack Complete Kitchen" = "Housing Quality: Lacking Complete Kitchen Facilities",
        "Lack Complete Plumbing" = "Housing Quality: Lacking Complete Plumbing Facilities"
      ),
    year = case_when(
  ...
  mutate(
    ...
    ylabs = case_when(
      ...
      var_label %in% c('Heat Vulnerability Index') ~ "Heat Vulnerability Index",
...
df_data_cube = df_data %>% 
  ...
  mutate(
    ...
    value_clean  = case_when(
      ...
      metric_name %in% c('Heat Vulnerability Index') ~ format(round(value, digits = 2), nsmall = 2) ,
