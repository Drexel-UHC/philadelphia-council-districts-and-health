...
assertthat::assert_that(
  all(df_metadata$var_name %in% colnames(sf_data)),
  msg = "Metadata variable names do not match data variable names"
)
assertthat::assert_that(
  all(sf_data %>% names() %>% discard(~.x%in%c("district","geometry"))  %in% df_metadata$var_name),
  msg = "Metadata variable names do not match data variable names"
)
