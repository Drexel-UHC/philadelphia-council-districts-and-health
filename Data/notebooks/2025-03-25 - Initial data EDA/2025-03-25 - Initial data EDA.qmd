...
The goal of this section is to start developing interactive EDA sections. Let's start by setting up the interactive packages we need.
...
Okay let's do both a distribution analysis as well as spatial analysis. 
...
layout_sidebar(
  sidebar = sidebar(
    shiny::selectizeInput(
      ...
      choices = names(df_data %>% select(-district)),
